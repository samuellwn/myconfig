...
hl.monitor({ output = "DP-2", mode = "preferred", position = "2880x0", scale = 1.3333, vrr = 1, bitdepth = 10, cm = "srgb" })
hl.monitor({ output = "DP-3", mode = "preferred", position = "5760x0", scale = 1.3333, vrr = 1, bitdepth = 10, cm = "srgb" })
